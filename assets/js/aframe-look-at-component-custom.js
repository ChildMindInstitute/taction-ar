...
/***/ (function(module, exports) {
	...
	AFRAME.registerComponent('look-at', {
	  ...
	  init: function () {
	  	console.log("look-at-custom init");
	    this.target3D = null;
	    this.vector = new THREE.Vector3();

	    //throttle tracking update
	   ...
	   */
	  update: function () {
	  	console.log("look-at-custom update");
	    var self = this;
	    ...
	    if (typeof target === 'object') {
	      return object3D.lookAt(new THREE.Vector3(target.x, target.y, target.z)); //********** CURT MOD
	    }
	  ...
	  tick: (function () {
	  	console.log("look-at-custom tick");
	    ...
	    return function (t) {
	      ...
	      if (target3D) {
	        ...
	        //************* CURT ADD TO CORRECT MODEL X ROTATION ******************

	        object3D.rotation.set(
			  (object3D.rotation.x + THREE.Math.degToRad(35)),
			  object3D.rotation.y,
			  object3D.rotation.z
			);
